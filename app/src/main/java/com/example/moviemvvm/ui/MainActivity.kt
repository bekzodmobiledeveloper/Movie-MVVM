...
import com.example.moviemvvm.ui.popular_movie.PopularMoviePagedListAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.networkState.observe(this, Observer {
            progressBar_popular.visibility = if (viewModel.listIsEmpty() && it == NetworkState.LOADING) View.VISIBLE else View.GONE
